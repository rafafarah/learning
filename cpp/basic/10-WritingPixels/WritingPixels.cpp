...
int main() {
	...
	memset(pBuffer, 0x00, SCREEN_WIDTH*SCREEN_HEIGHT*sizeof(Uint32));

	for (int i=0; i<SCREEN_WIDTH * SCREEN_HEIGHT; i++) {
//		pBuffer[i] = 0xFF0000FF; // Red
//		pBuffer[i] = 0x00FF00FF; // Green
		pBuffer[i] = 0x0000FFFF; // Blue
//		pBuffer[i] = 0xFF00FFFF; // Magenta
//		pBuffer[i] = 0xFFFF00FF; // Yellow
//		pBuffer[i] = 0x00FFFFFF; // Cyan
	}
