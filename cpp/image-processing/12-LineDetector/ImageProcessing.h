...
static const int HORIZONTAL_MASK[3][3] = { { -1, 2, -1 },
										   { -1, 2, -1 },
										   { -1, 2, -1 } };

static const int VERTICAL_MASK[3][3] = { { -1, -1, -1 },
										 {  2,  2,  2 },
										 { -1, -1, -1 } };

static const int RIGHT_DIAGONAL_MASK[3][3] = { {  2, -1, -1 },
										 	   { -1,  2, -1 },
											   { -1, -1,  2 } };

static const int LEFT_DIAGONAL_MASK[3][3] = { { -1, -1,  2 },
										 	  { -1,  2, -1 },
											  {  2, -1, -1 } };
